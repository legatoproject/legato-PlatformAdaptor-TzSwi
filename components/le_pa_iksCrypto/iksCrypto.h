...
/** @file iksCrypto.h
 *
 * Provides a IoT Keystore based component that allows a process to generate new keys and use
 * the keys to encrypt and decrypt data.
 *
 * Copyright (C) Sierra Wireless Inc.
 */
//--------------------------------------------------------------------------------------------------

#ifndef LEGATO_IKSCRYPTO_INCLUDE_GUARD
#define LEGATO_IKSCRYPTO_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t iksCrypto_GenerateKey
(
...
/**-----------------------------------------------------------------------------------------------
 *
 * Encrypt plain text data using key generated by IoT Keystore.
 *
 * @return
 *      - LE_OK
 *      - LE_FAULT
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t iksCrypto_EncryptData
(
...
/**-----------------------------------------------------------------------------------------------
 *
 * Decrypt encrypted data using key generated by IoT Keystore.
 *
 * @return
 *      - LE_OK
 *      - LE_FAULT
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t iksCrypto_DecryptData
(
    uint8_t* keyPtr,                    ///< [IN] Key.
    uint32_t keySize,                   ///< [IN] Size of key.
...
#endif  // LEGATO_IKSCRYPTO_INCLUDE_GUARD
